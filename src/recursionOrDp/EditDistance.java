...
class EditDistance {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("For 1 is: " + result1 + " time: " + duration1 + " seconds");
        ...
        System.out.println("For 2 is: " + result2 + " time: " + duration2 + " seconds");
    }
}